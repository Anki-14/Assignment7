...
const About = () => {
  return (
    <div className="about-container">
           ...
           <h1>About Innomatics</h1>
	   <p><span className="black">Innomatics Research Labs</span> is a pioneer in <span className="black">“Transforming Career and Lives”</span> of individuals in the Digital Space by catering advanced training on <span className="crimson">NASSCOM FutureSkills Prime Certified Data Science</span>, <span className="black">Machine Learning</span>, <span className="black">Artificial Intelligence (AI)</span>, <span className="crimson">Full Stack Development</span>, <span className="crimson">Amazon Web Services (AWS)</span>, <span className="crimson">DevOps</span>, <span className="crimson">Microsoft Azure</span>, <span className="black">Big data Analytics</span>, and <span className="crimson">Digital Marketing</span>. We are passionate about bridging the gap between learning and real-time implementation, so empowering individuals to be industry-ready and help firms in reaping huge benefits is our primary goal.</p>
         ...
         <div className="card-container">
            <div className="card">
                ...
                <div className="para">
                   <p>Trainees are gaining knowledge  with us, and the number is continues growing with our Innomatics family</p>
                </div>
            </div>
            ...
            <div className="card">
                ...
                <div className="para">
                   <p>More than 400+ Our skilled students posted there success story  with us, </p>
                </div>
            </div>
            ...
            <div className="card">
                ...
                <div className="para">
                   <p>Innomatics Research Labs now partner with more than 300 fortune companies all over the world</p>
                </div>
            </div>
            ...
            <div className="card">
                ...
                <div className="para">
                   <p>We are now connected with 500+ market leading company to provide you sameless experience with industry ready skills</p>
                </div>
            </div>
        </div>
      </div>
